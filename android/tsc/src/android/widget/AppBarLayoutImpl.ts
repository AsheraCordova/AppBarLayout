...
export abstract class AppBarLayoutImpl<T> extends ViewGroupImpl<T>{
	...
	@decorate(Expose({ name: "statusBarForeground" }))
	statusBarForeground!:CommandAttr<string>| undefined;
	@decorate(Type(() => CommandAttr))
	@decorate(Expose({ name: "expanded" }))
	expanded!:CommandAttr<boolean>| undefined;
	@decorate(Type(() => CommandAttr))
	@decorate(Expose({ name: "liftOnScroll" }))
	liftOnScroll!:CommandAttr<boolean>| undefined;
	@decorate(Type(() => CommandAttr))
	@decorate(Expose({ name: "liftOnScrollTargetViewId" }))
	liftOnScrollTargetViewId!:CommandAttr<string>| undefined;
	@decorate(Type(() => CommandAttr))
	...
	reset() : T {	
		super.reset();
		this.statusBarForeground = undefined;
		this.expanded = undefined;
		this.liftOnScroll = undefined;
		this.liftOnScrollTargetViewId = undefined;
	...
	public setStatusBarForeground(value : string) : T {
		this.resetIfRequired();
		if (this.statusBarForeground == null || this.statusBarForeground == undefined) {
			this.statusBarForeground = new CommandAttr<string>();
		}
		
		this.statusBarForeground.setSetter(true);
		this.statusBarForeground.setValue(value);
		this.orderSet++;
		this.statusBarForeground.setOrderSet(this.orderSet);
		return this.thisPointer;
	}
	...
	public setLiftOnScroll(value : boolean) : T {
		this.resetIfRequired();
		if (this.liftOnScroll == null || this.liftOnScroll == undefined) {
			this.liftOnScroll = new CommandAttr<boolean>();
		}
		
		this.liftOnScroll.setSetter(true);
		this.liftOnScroll.setValue(value);
		this.orderSet++;
		this.liftOnScroll.setOrderSet(this.orderSet);
		return this.thisPointer;
	}
		

	public setLiftOnScrollTargetViewId(value : string) : T {
		this.resetIfRequired();
		if (this.liftOnScrollTargetViewId == null || this.liftOnScrollTargetViewId == undefined) {
			this.liftOnScrollTargetViewId = new CommandAttr<string>();
		}
		
		this.liftOnScrollTargetViewId.setSetter(true);
		this.liftOnScrollTargetViewId.setValue(value);
		this.orderSet++;
		this.liftOnScrollTargetViewId.setOrderSet(this.orderSet);
		return this.thisPointer;
	}
